...
<main class="app-main">
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Edit Tehsil</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Tehsil Master</a></li>
                        <li class="breadcrumb-item active">Edit Tehsil</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">Update Tehsil</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('tehsils.update', $tehsil->id) }}">
                    @csrf
                    @method('PUT')
