                            ...
                            <form method="POST" action="{{ route('trips.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <input type="text" name="place_to_visit" class="form-control"
                                            value="{{ old('place_to_visit') }}">
                                    </div>

                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">Start Location</label>
                                        <div class="input-group">
                                            <input type="text" name="start_lat" id="start_lat" class="form-control me-2"
                                                placeholder="Latitude" required>
                                            <input type="text" name="start_lng" id="start_lng" class="form-control"
                                                placeholder="Longitude" required>
                                        </div>
                                        <button type="button" class="btn btn-sm btn-outline-secondary mt-2"
                                            onclick="setCurrentLocation('start')">Use Current Location</button>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="end_lat" id="end_lat"
                                                class="form-control me-2" placeholder="Latitude" required>
                                            <input type="text" name="end_lng" id="end_lng" class="form-control"
                                                placeholder="Longitude" required>
                                        </div>
                                        <button type="button" class="btn btn-sm btn-outline-secondary mt-2"
                                            onclick="setCurrentLocation('end')">Use Current Location</button>
                                    </div>

                                    <div class="mb-3 col-md-3">
                                        <label for="starting_km" class="form-label">Opening (km)</label>
                                        <input type="text" name="starting_km" id="starting_km" class="form-control"
                                            value="{{ old('starting_km') }}">
                                    </div>

                                    <div class="mb-3 col-md-3">
                                        <label for="start_km_photo" class="form-label">Opening KM Image</label>
                                        <input type="file" name="start_km_photo" id="start_km_photo"
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <input type="text" name="end_km" id="end_km" class="form-control"
                                            value="{{ old('end_km') }}">
                                    </div>

                                    <div class="mb-3 col-md-3">
                                        <label for="end_km_photo" class="form-label">End KM Image</label>
                                        <input type="file" name="end_km_photo" id="end_km_photo" class="form-control"
                                            accept="image/*">
                                    </div>
