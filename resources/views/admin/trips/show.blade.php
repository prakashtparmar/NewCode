        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="mt-3 text-end">
                    <a href="{{ route('trips.index') }}" class="btn btn-outline-secondary"> <i class="fas fa-arrow-left me-1"></i> Back to Trips </a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge @if ($trip->approval_status == 'approved') bg-success @elseif($trip->approval_status == 'denied') bg-danger @else bg-secondary @endif p-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($trip->starting_km !== null && $trip->end_km !== null) {{ $trip->end_km - $trip->starting_km }} km @else N/A @endif
                                    </td>
                                </tr>
                                <tr>
