            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li
                    ...
                    <a href="#"
                        ...
                        <i
                            class="bi {{ request()->is('admin/users*') || request()->is('admin/roles*') || request()->is('admin/permissions*') ? 'bi-chevron-down' : 'bi-chevron-right' }}"></i>
                    </a>
                ...
                <li
                    ...
                    <a href="#"
                        class="nav-link d-flex justify-content-between align-items-center {{ request()->is('admin/trips*') || request()->is('admin/trip-types*') || request()->is('admin/travel-modes*') || request()->is('admin/purposes*') ? 'active' : '' }}">
                        <span>
                            <i class="bi bi-truck-front me-2"></i> Trips
                        </span>
                        <i
                            class="bi {{ request()->is('admin/trips*') || request()->is('admin/trip-types*') || request()->is('admin/travel-modes*') || request()->is('admin/purposes*') ? 'bi-chevron-down' : 'bi-chevron-right' }}"></i>
                    </a>
                    <ul class="nav nav-treeview ps-4"
                        style="{{ request()->is('admin/trips*') || request()->is('admin/trip-types*') || request()->is('admin/travel-modes*') || request()->is('admin/purposes*') ? 'display: block;' : 'display: none;' }}">
                    ...
                    <ul class="nav nav-treeview ps-4"
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/hr/designations') }}"
                                ...
                                <i class="bi bi-people-fill me-2"></i> Designation
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="#"
                                ...
                                <i
                                    class="bi {{ request()->is('admin/hr/leave*') ? 'bi-chevron-down' : 'bi-chevron-right' }}"></i>
                            </a>
                            <ul class="nav nav-treeview ps-4"
