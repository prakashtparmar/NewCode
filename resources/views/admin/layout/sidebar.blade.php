  ...
  <div class="sidebar-wrapper">
    <nav class="mt-3">
      <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
        ...
        <!-- Trip Management -->
        <li class="nav-item {{ request()->is('admin/trips*') || request()->is('admin/trip-types*') || request()->is('admin/travel-modes*') || request()->is('admin/purposes*') ? 'menu-open' : '' }}">
          <a href="#" class="nav-link {{ request()->is('admin/trips*') || request()->is('admin/trip-types*') || request()->is('admin/travel-modes*') || request()->is('admin/purposes*') ? 'active' : '' }}">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{ url('admin/trips/tourtype') }}" class="nav-link {{ request()->is('admin/trips/tourtype*') ? 'active' : '' }}">
                <i class="bi bi-tag me-2"></i>
                <p>Trip Types</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ url('admin/trips/travelmode') }}" class="nav-link {{ request()->is('admin/trips/travelmode*') ? 'active' : '' }}">
                <i class="bi bi-signpost me-2"></i>
                <p>Travel Modes</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ url('admin/trips/purpose') }}" class="nav-link {{ request()->is('admin/trips/purpose*') ? 'active' : '' }}">
